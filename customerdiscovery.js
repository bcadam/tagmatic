(function() {
    ...
    function classifyTweetsSentiment(tweets) {
        ...
        classifier.get("3nJ74rxTWl", {
                success: function(result) {
                    ...
                    //console.log(restoredClassifier.getClassifications('i am long copper'));
    ...
    // var readyTweets = classifyTweetsSentiment(tweets);

})();

// returnFollowers(tweets);
// returnWords(tweets);
// returnLocations(tweets);
