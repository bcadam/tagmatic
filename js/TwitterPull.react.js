    ...
    render: function() {
        ...
        if (self.state.data == null) {
            return (<div id="twitterform" style={fileFormContainer}>
                    <input style={formFormat} placeholder="Words to search for" type="text" value={self.state.searchValue} onChange={self._onChange} /><input style={formFormat} placeholder="English only" type="checkbox" value={self.state.language} onChange={self._onChangeLanguage}><div style={buttonForm}>Request English only</div></input>
